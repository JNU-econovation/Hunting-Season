...
public class Swordman : PlayerController
{
    ...
    private void Update()
    {
        ...
        if(LevelLoader.Instance.isBigMap)
            transform.position = new Vector3(Mathf.Clamp(transform.position.x, -50f, 25f), transform.position.y, transform.position.z);
        else
            transform.position = new Vector3(Mathf.Clamp(transform.position.x, -50f, -13f), transform.position.y, transform.position.z);
